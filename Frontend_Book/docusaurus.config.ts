...
const config: Config = {
  ...
  url: 'https://physical-ai-humanoid-textbook-three.vercel.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/your-username/Physical-AI-Humanoid-textbook/tree/main/Frontend_Book/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} ROS 2 for Humanoid Robotics Guide. Built with Docusaurus.`,
    },
    prism: {
